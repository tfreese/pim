...
public class JavaMailContent implements IMailContent
{
    ...
    */
    ...
    /**
     * @see de.freese.pim.core.mail.api.IMailContent#getInlineDataSource(java.lang.String)
     */
    @Override
    ...
    /**
     * @see de.freese.pim.core.mail.api.IMailContent#getMessageContent()
     */
    @Override
    ...
    /**
     * @see de.freese.pim.core.mail.api.IMailContent#getMessageContentType()
     */
    @Override
