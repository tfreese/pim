...
--CREATE ALIAS SYSTEM_USER_NAME FOR 'de.freese.pim.core.utils.Utils.getSystemUserName';
CREATE ALIAS SYSTEM_USER_NAME AS 'String getSystemUserName() { return System.getProperty("user.name").toUpperCase(); }';
